...
@Component({
  selector: 'app-cash-registers-details',
  standalone: true,
  imports: [SharedModule,CashRegisterDetailPipe],
  templateUrl: './cash-registers-details.component.html',
  styleUrl: './cash-registers-details.component.css'
})
export class CashRegistersDetailsComponent {
